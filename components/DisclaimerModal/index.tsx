      ...
      <DialogContent dividers>
        <>
          <Typography variant="body1" mb={2}>
            Exactly is an open source, non-custodial protocol on Ethereum Blockchain, that brings fixed-income solutions
            for lenders and borrowers (the &quot;Platform&quot;). The Platform will permit its users, among other
            things, enter into certain transaction involving digital assets (including but not limited to digital loans
            and credit products) (the &quot;Digital Assets Services&quot;).
          </Typography>
          <Typography variant="body1" mb={2}>
