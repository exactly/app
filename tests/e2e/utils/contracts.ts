...
import auditorContract from '@exactly/protocol/deployments/optimism/Auditor.json';
import marketETHRouter from '@exactly/protocol/deployments/optimism/MarketETHRouter.json';
